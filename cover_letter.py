...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  body {{ font-family:'Georgia',serif; background:#fff; color:#1a1a1a; padding:36px 48px; line-height:1.6; max-width:794px; margin:0 auto; }}
</style>
</head>
<body>
  <!-- HEADER -->
...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  body {{ font-family:'Segoe UI',Arial,sans-serif; background:#fff; color:#1f2937; padding:36px 48px; line-height:1.6; max-width:794px; margin:0 auto; }}
</style>
</head>
<body>
  <!-- HEADER BAND -->
...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  body {{ font-family:'Segoe UI',Arial,sans-serif; background:#fff; color:#1f2937; padding:0; line-height:1.6; max-width:794px; margin:0 auto; }}
</style>
</head>
<body>
...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  body {{ font-family:'Georgia',serif; background:#fff; color:#1a1a1a; padding:0; line-height:1.6; max-width:794px; margin:0 auto; }}
</style>
</head>
<body>
...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  body {{ font-family:Arial,Helvetica,sans-serif; background:#fff; color:#111827; padding:36px 48px; line-height:1.6; font-size:14px; max-width:794px; margin:0 auto; }}
