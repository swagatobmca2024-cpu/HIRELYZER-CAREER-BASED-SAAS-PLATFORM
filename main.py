        ...
        with cc1:
            if st.button("✅ Yes, Clear", key="confirm_clear_yes", use_container_width=True):
                ...
                for _key in ["pdf_resume_bytes", "ai_output", "cover_letter",
                             "cover_letter_pdf", "encoded_profile_image", "generated_html", "cover_letter_html"]:
...
with tab2:
    ...
    if st.session_state.get("pdf_resume_bytes"):
        ...
        if st.session_state.get("cover_letter_pdf"):
            ...
            with col2:
                # DOCX from plain text body stored by generate_cover_letter_from_resume_builder
                ...
                if cover_letter_text:
                    try:
                        ...
                        for _line in cover_letter_text.split("\n"):
