                ...
                if questions_answered < st.session_state.original_num_questions:
                    ...
                    if _fresh_remaining <= 0 and not st.session_state.dynamic_answer_submitted:
                        ...
                        _auto_spinner_text = (
                            ...
                            else "⏰ Time's up! Recording your answer..."
                        )
                        with st.spinner(_auto_spinner_text):
                            _process_submission(
                    ...
                    if not st.session_state.dynamic_answer_submitted:
                        if st.button("Submit Answer & Get Feedback"):
                            if answer.strip():
                                _submit_spinner_text = (
                                    "Evaluating your answer..."
                                    if st.session_state.interview_difficulty == "Hard"
                                    else "Recording your answer..."
                                )
                                with st.spinner(_submit_spinner_text):
                                    _process_submission(
                                        answer, question,
                                        st.session_state.current_dynamic_interview_question,
                                        questions_answered
