...
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#374151,#4b5563);color:#ffffff;padding:36px 24px;vertical-align:top;'>
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#1e293b,#334155);color:white;padding:36px 24px;vertical-align:top;'>
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#1e3a8a,#1d4ed8);color:white;padding:36px 24px;vertical-align:top;'>
    {'<div style="margin:0 auto 14px;text-align:center;">' + fixed_img + '</div>' if fixed_img else ''}
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:29%;background:#fff;border-right:2px solid #a7f3d0;padding:32px 22px;vertical-align:top;'>
    {'<div style="margin:0 auto 14px;text-align:center;">' + fixed_img + '</div>' if fixed_img else ''}
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#7c2d12,#b45309);color:white;padding:34px 22px;vertical-align:top;'>
    {'<div style="margin:0 auto 14px;text-align:center;">' + fixed_img + '</div>' if fixed_img else ''}
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#0d1b3e,#1a2f6b);color:#f5e6b2;padding:34px 22px;vertical-align:top;'>
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#0f766e,#0d9488);color:#ccfbf1;padding:34px 22px;vertical-align:top;'>
    {'<div style="margin:0 auto 12px;text-align:center;">' + fixed_img + '</div>' if fixed_img else ''}
...
<table role='presentation' style='width:100%;border-collapse:collapse;table-layout:fixed;'>
<tr>
  <td style='width:30%;background:linear-gradient(180deg,#1e1b4b,#312e81);color:#a5f3fc;padding:34px 22px;vertical-align:top;'>
    {'<div style="margin:0 auto 12px;text-align:center;">' + fixed_img + '</div>' if fixed_img else ''}
    <h1 style='font-size:20px;font-weight:800;color:#ffffff;text-align:center;margin-bottom:3px;'>{session_state.get('name','')}</h1>
...
def render_template_forest_green(session_state, profile_img_html=""):
    ...
    html_content = f"""<!DOCTYPE html>
<html lang='en'>
<head><meta charset='UTF-8'><meta name='viewport' content='width=794px'><title>{session_state.get('name','')} - Resume</title></head>
